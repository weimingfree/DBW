...
<div id="addAll">
    ...
    <div id="table">
        <form action="${pageContext.request.contextPath}/scInfo/update.action" enctype="multipart/form-data" method="post" id="myform">
            <table>
                <tr>
                    <td><input type="hidden" name="scid" class="two" value="${thissc.scid}"></td>
                </tr>
                <tr>
                    <td class="one">学生号</td>
